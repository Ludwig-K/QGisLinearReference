...
class PolDialog(QDockWidget):
    """Dialog for QGis-Plugin LinearReferencing, Point-on-line-Features
    note:
    ...
    def __init__(self, parent=None):
        ...
        if True:
            ...
            measurement_container_wdg.setStyleSheet("QWidget {background-color: #FFFFFFFF;}")
            ...
            # shows the current selected reference-layer and type
            self.qlbl_selected_ref_lyr = QLabel()
            self.measurement_grb.layout().addWidget(
                self.qlbl_selected_ref_lyr, row, 1, 1, 2
            )

            self.qtb_measurement_data_layer = QToolBar()
            self.qtb_measurement_data_layer.setIconSize(QSize(18,18))
            self.measurement_grb.layout().addWidget(self.qtb_measurement_data_layer, row,3)
            ...
            self.measurement_grb.layout().addWidget(
                self.qcbn_ref_lyr_select, row, 1, 1, 2
            )

            self.qtb_measurement_reference_layer = QToolBar()
            self.qtb_measurement_reference_layer.setIconSize(QSize(18,18))
            self.measurement_grb.layout().addWidget(self.qtb_measurement_reference_layer, row, 3)
            ...
            self.measurement_grb.layout().addWidget(
                self.qtb_measurement_tools, row, 1, 1, 2
            )
            ...
            if True:
                ...
                self.measurement_grb.layout().addWidget(self.qtb_edit_data_feature_post, row,1,1,3)
            ...
            if True:
                ...
                self.measurement_grb.layout().addWidget(
                    self.cbx_n_abs_grp, row, 0, 1, 3
                )

                row += 1

                self.dspbx_n_abs = QDoubleSpinBoxDefault(
                    self, 0, sys.float_info.max
                )
                self.dspbx_n_abs.setToolTip(MY_DICT.tr("n_abs_ttp"))
                self.measurement_grb.layout().addWidget(self.dspbx_n_abs, row, 1)
            # n-fract
            if True:
                row += 1
                ...
                self.measurement_grb.layout().addWidget(
                    self.cbx_n_fract_grp, row, 0, 1, 3
                )

                row += 1
                self.dspbx_n_fract = QDoubleSpinBoxDefault(self, 0, 100)
                self.dspbx_n_fract.setToolTip(MY_DICT.tr("n_fract_ttp"))
                self.measurement_grb.layout().addWidget(self.dspbx_n_fract, row, 1)
            ...
            if True:
                ...
                self.dspbx_m_abs = QDoubleSpinBoxDefault(self)
                self.dspbx_m_abs.setToolTip(MY_DICT.tr("m_abs_ttp"))
                self.measurement_grb.layout().addWidget(self.dspbx_m_abs, row, 1)
                ...
                self.measurement_grb.layout().addWidget(self.qlbl_m_valid_hint, row, 1,1,2)
            # m-fract
            if True:
                ...
                self.measurement_grb.layout().addWidget(
                    self.cbx_m_fract_grp, row, 0, 1, 3
                )
                row += 1
                self.dspbx_m_fract = QDoubleSpinBoxDefault(self, 0, 100)
                self.dspbx_m_fract.setToolTip(MY_DICT.tr("m_fract_ttp"))
                self.measurement_grb.layout().addWidget(self.dspbx_m_fract, row, 1)
            ...
            if True:
                ...
                self.measurement_grb.layout().addWidget(
                    self.cbx_z_grp, row, 0, 1, 3
                )

                row += 1
                self.dnspbx_z = QDoubleNoSpinBox(self)
                self.measurement_grb.layout().addWidget(self.dnspbx_z, row, 1)
            ...
            if True:
                ...
                self.dnspbx_snap_x = QDoubleNoSpinBox(self)
                self.measurement_grb.layout().addWidget(self.dnspbx_snap_x, row, 1)

                self.dnspbx_snap_y = QDoubleNoSpinBox(self)
                self.measurement_grb.layout().addWidget(self.dnspbx_snap_y, row, 2)
        ...
        if True:
            ...
            qgb_po_pro_settings = QGroupBoxExpandable(
                MY_DICT.tr("qgb_po_pro_settings_ttl"), False, self
            )
            ...
            self.po_pro_delegates = {}
            self.po_pro_delegates[0] = MyPaddingLeftDelegate(
                50
            )
            self.qtrv_po_pro_selection.setItemDelegateForColumn(0, self.po_pro_delegates[0])

            self.po_pro_delegates[1] = MyPaddingLeftDelegate(
                80
            )
            self.qtrv_po_pro_selection.setItemDelegateForColumn(1, self.po_pro_delegates[1])
        ...
        if True:
            ...
            if True:
                ...
                self.qcbn_ref_lyr.clear_button_icon = QIcon(
                ...
                self.qcbn_ref_lyr_id_field.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
                ...
                self.qcbn_data_lyr.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
                ...
                self.qcbn_data_lyr_id_field.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
                ...
                self.qcbn_data_lyr_reference_field.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
                ...
                layers_and_fields_grb.layout().addWidget(
                    QLabel(MY_DICT.tr("data_lyr_stationing_field_lbl"), self),
                    row,
                    0,
                )
                ...
                self.qcbn_data_lyr_stationing_field = (
                    MyFieldSelectorQComboBox(self, column_pre_settings)
                )
                self.qcbn_data_lyr_stationing_field.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
                self.qcbn_data_lyr_stationing_field.setToolTip(
                    MY_DICT.tr("data_lyr_stationing_field_ttp")
                )

                layers_and_fields_grb.layout().addWidget(
                    self.qcbn_data_lyr_stationing_field, row, 1
                )
                ...
                self.qcbn_show_lyr.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
                ...
                self.qcbn_show_lyr_back_reference_field.clear_button_icon = QIcon(
                    ":icons/backspace-outline.svg"
                )
        ...
        self.tbw_central.setTabToolTip(5, MY_DICT.tr('po_pro_tab_ttp'))
        ...
        self.pbtn_tool_mode_indicator = QtbIco(
            QIcon(":icons/mActionIdentify.svg"),
...
if __name__ == "__main__":
    sys.path.append(
        "C:/Users/ludwig.kniprath/AppData/Roaming/QGIS/QGIS3/profiles/2022-05-02/python/plugins/LinearReferencing"
    )
